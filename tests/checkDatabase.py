...
import datetime
# Function to requests the individual data types that you can also query as a composite metric for all
# storage used by Alarms, Statistics, Events, and Tasks in the vCenter Server instance
